...
class Home extends AppController
{
    ...
    {
        $receiptId = trim(inputPost('receipt_id', FILTER_UNSAFE_RAW));
        $items = filter_var(inputPost('item'), FILTER_UNSAFE_RAW, FILTER_FORCE_ARRAY);
        ...
        $insertData = [
            ...
            'buyer' => trim(inputPost('buyer', FILTER_UNSAFE_RAW)),
            'receipt_id' => $receiptId,
            'items' => rtrim(implode(',', $items), ','),
            'buyer_email' => inputPost('buyer_email', FILTER_SANITIZE_EMAIL),
            'note' => strip_tags(inputPost('note', FILTER_UNSAFE_RAW)),
            'buyer_ip' => getIpAddress(),
            'city' => trim(inputPost('city', FILTER_UNSAFE_RAW)),
